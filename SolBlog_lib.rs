// Credits due to https://github.com/DougAnderson444/solblog 
// Using the The Anchor Version Manager AVM is recommended https://book.anchor-lang.com/chapter_4/avm.html
// 1. $'AVM install 0.16.1'
// 2. $'AVM use 0.16.1'
